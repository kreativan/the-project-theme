...
if (!empty($_POST['contact_submit'])) {
  ...
  try {
    ...
    if( wp_mail($sent_to, $subject, $message, $headers) ) {
      ...
      $response["modal"] = "<p>" . __('Your message has been sent. Thank you for your time!') . "</p>";

    } else {

      $response["danger"] = "danger";
      $response["notification"] = "<p>" . __('There was an error, please try again') . "</p>";
